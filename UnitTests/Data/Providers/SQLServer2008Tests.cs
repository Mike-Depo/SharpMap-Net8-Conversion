...
namespace UnitTests.Data.Providers
{
    ...
    public class SQLServer2008DbTests
    {
        ...
        /// </summary>
        private Envelope GetTestEnvelope(SharpMap.Data.Providers.SqlServerSpatialObjectType spatialType)
        {
        ...
        public void TestGetExtentsQueryIndividualFeatures(SharpMap.Data.Providers.SqlServerSpatialObjectType spatialType)
        {
            ...
            Envelope extents = sq.GetExtents();
        ...
        public void TestPerformanceSqlServer2008ExProvider()
        {
            ...
            Envelope envelope = GetTestEnvelope(spatialType);
            ...
            double x1, double x2, double y1, double y2)
        {
            ...
            sq.ExecuteIntersectionQuery(new Envelope(x1, x2, y1, y2), ds);

...
namespace ExampleCodeSnippets
{
    ...
    {
public static void EnsureVisible(SharpMap.Map map, Coordinate pt)
{
    ...
    var ls = map.Factory.CreateLineString(new Coordinate[] {evbb.Centre, pt});
    ...
    map.Center = new Coordinate(map.Center.X + dx, map.Center.Y + dy);
        ...
        public void TestEnsureVisible()
        {
            ...
            EnsureVisible(map, new Coordinate(-30, 0));
            System.Console.WriteLine(map.Center);
            System.Console.WriteLine();
            EnsureVisible(map, new Coordinate(15, 20));
            System.Console.WriteLine(map.Center);
            System.Console.WriteLine();
            EnsureVisible(map, new Coordinate(15, -20));
            System.Console.WriteLine(map.Center);

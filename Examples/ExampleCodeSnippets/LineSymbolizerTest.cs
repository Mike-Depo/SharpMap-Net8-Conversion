    ...
    SharpMap.Rendering.Symbolizer.ILineSymbolizer
{
    ...
    private void OnRenderInternal(SharpMap.MapViewport map, LineString lineString,
        System.Drawing.Graphics graphics)
    {
        ...
        if (length < RepeatInterval + ArrowLength)
        {
            ...
            var arrow = (LineString) lil.ExtractLine(start, end);
        ...
        {
            var arrow = (LineString) lil.ExtractLine(offset, offset + ArrowLength);
            RenderArrow(map, graphics, arrow);
    ...
    private void RenderArrow(SharpMap.MapViewport map, System.Drawing.Graphics graphics, LineString arrow)
    {
    ...
    public void Render(SharpMap.MapViewport map, ILineal geometry, System.Drawing.Graphics graphics)
    {
        if (geometry is MultiLineString)
        {
            var mls = (MultiLineString) geometry;
            for (var i = 0; i < mls.Count; i++)
            {
                OnRenderInternal(map, (LineString) mls.GetGeometryN(i), graphics);
            }
            return;
        }
        OnRenderInternal(map, (LineString) geometry, graphics);
    }
    ...
    public class LineSymbolizerTest
    {
        ...
        {
            NetTopologySuite.NtsGeometryServices.Instance = NetTopologySuite.NtsGeometryServices.Instance;
        }
        ...
        public void TestTransformation()
        {
            ...
            new SharpMap.Data.Providers.GeometryProvider(m.Factory.CreatePoint(new Coordinate(0, 51.478885))),
            ...
            e = TransformMethods.TransformBox(e,

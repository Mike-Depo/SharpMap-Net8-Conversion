...
namespace SharpMap.Layers
{
    ...
    public class LabelLayer : Layer
    {
        ...
        /// <para>The label delegate must take a <see cref="SharpMap.Data.FeatureDataRow"/> and return a Coordinate.</para>
        ...
        ///				{ return new Coordinate(Convert.ToDouble(fdr["LabelX"]), Convert.ToDouble(fdr["LabelY"]));};
        /// </code>
        /// </example>
        /// </remarks>
